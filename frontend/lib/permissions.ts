export enum OrganizationPermissions {
  ...
  // KopoKopo Payment Integration Permissions
  VIEW_KOPOKOPO_CONFIG = "VIEW_KOPOKOPO_CONFIG",
  MANAGE_KOPOKOPO_CONFIG = "MANAGE_KOPOKOPO_CONFIG",
  VIEW_KOPOKOPO_TRANSACTIONS = "VIEW_KOPOKOPO_TRANSACTIONS",
